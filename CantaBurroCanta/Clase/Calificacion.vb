...
Public Class Calificacion
    ...
    Public Function obtenerCalificacion() As Boolean
        Dim strSQL As String
        Dim xCnx As New Oracle
        Dim xDT As DataTable
        ...
        If idCategoria <> 0 And idParticipante <> 0 And idJuez <> 0 Then
            ...
            obtenerCalificacion = False
            xDT = xCnx.objetoDataAdapter(strSQL)
            If xDT.Rows.Count = 1 Then
                formDeCalificaciones.CB_participante.Text = CStr(xDT.Rows(0)("Participante"))
                formDeCalificaciones.CB_categoria.Text = CStr(xDT.Rows(0)("Categoria"))
                formDeCalificaciones.CB_juez.Text = CStr(xDT.Rows(0)("Juez"))
                formDeCalificaciones.TB_calificacion.Text = CStr(xDT.Rows(0)("Calificacion"))



                obtenerCalificacion = True
            End If
        End If
    End Function
