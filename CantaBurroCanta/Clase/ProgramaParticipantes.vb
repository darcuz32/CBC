...
Public Class ProgramaParticipantes
    ...
    Public Function obtenerParticipacion() As Boolean
        Dim strSQL As String
        Dim xCnx As New Oracle
        Dim xDT As DataTable
        ...
        If idCategoria <> 0 And idParticipante <> 0 Then
            ...
            obtenerParticipacion = False
            xDT = xCnx.objetoDataAdapter(strSQL)
            If xDT.Rows.Count = 1 Then
                formDeProgramaParticipantes.CB_participante.Text = CStr(xDT.Rows(0)("Participante"))
                formDeProgramaParticipantes.CB_categoria.Text = CStr(xDT.Rows(0)("Categoria"))
                formDeProgramaParticipantes.CB_auditorio.Text = CStr(xDT.Rows(0)("Auditorio"))
                formDeProgramaParticipantes.TB_fecha.Text = CStr(xDT.Rows(0)("Fecha"))



                obtenerParticipacion = True
            End If
        End If
    End Function
